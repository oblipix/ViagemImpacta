...
import HotelsSearchFormAtomic from '../molecules/HotelsSearchFormAtomic/HotelsSearchFormAtomic';
...
function HomePageAtomic({
  ...
  return (
    <div className="min-h-screen">
      ...
      <TravelSectionAtomic travels={packages} />
      
      {/* 🏨 HOTÉIS RECOMENDADOS */}
      <RecommendedHotelsSectionAtomic hotels={hotels} onHotelClick={onHotelClick} />
