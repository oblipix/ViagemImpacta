                                    ...
                                    <div key={room.id || index} className="bg-white border border-gray-200 rounded-lg sm:rounded-xl p-4 sm:p-6 hover:shadow-lg transition-all duration-300 flex flex-col lg:flex-row justify-between items-start lg:items-center group">
                                        ...
                                        <div className="w-full lg:w-auto lg:ml-6 flex flex-col lg:flex-col items-center lg:items-end">
                                            ...
                                            <button
                                                ...
                                                className={`reservation-button font-bold py-2 px-4 sm:py-3 sm:px-6 rounded-lg sm:rounded-xl transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105 text-sm sm:text-base w-full lg:w-auto ${isLoggedIn
                    ...
                    <ScrollReveal animation="zoomIn" delay={900}>
                        <div className="text-center mb-8">
                            <button
                                ...
                                className={`px-10 py-4 font-bold text-xl rounded-full transition duration-300 shadow-lg transform hover:scale-105 ${isLoggedIn
