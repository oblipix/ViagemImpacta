...
import TestAtomicHotelDetails from './TestAtomicHotelDetails'; // 🧪 TESTE HOTEL DETAILS ATÔMICA
import TestTravelSectionAtomic from './TestTravelSectionAtomic'; // 🧪 TESTE TRAVEL SECTION ATÔMICA
import TestEventBlogSectionAtomic from './TestEventBlogSectionAtomic'; // 🧪 TESTE EVENT BLOG SECTION ATÔMICA
import TestNewsletterSectionAtomic from './TestNewsletterSectionAtomic'; // 🧪 TESTE NEWSLETTER SECTION ATÔMICA
import TestRecommendedHotelsSectionAtomic from './TestRecommendedHotelsSectionAtomic'; // 🧪 TESTE RECOMMENDED HOTELS SECTION ATÔMICA
import TestHotelsMapSectionAtomic from './TestHotelsMapSectionAtomic'; // 🧪 TESTE HOTELS MAP SECTION ATÔMICA
import TestBlogSectionAtomic from './TestBlogSectionAtomic'; // 🧪 TESTE BLOG SECTION ATÔMICA
import TestPromotionDetailsPageAtomic from './TestPromotionDetailsPageAtomic'; // 🧪 TESTE PROMOTION DETAILS PAGE ATÔMICA
import TestPurchasePageAtomic from './TestPurchasePageAtomic'; // 🧪 TESTE PURCHASE PAGE ATÔMICA
import TestPaymentPageAtomic from './TestPaymentPageAtomic'; // 🧪 TESTE PAYMENT PAGE ATÔMICA
import TestAuthAndUserPagesAtomic from './components/TestAuthAndUserPagesAtomic'; // 🧪 TESTE AUTH AND USER PAGES ATÔMICA
import LoginPageAtomic from './components/LoginPageAtomic'; // 🎯 LOGIN PAGE ATÔMICA
import RegisterPageAtomic from './components/RegisterPageAtomic'; // 🎯 REGISTER PAGE ATÔMICA
import MyTravelsPageAtomic from './components/MyTravelsPageAtomic'; // 🎯 MY TRAVELS PAGE ATÔMICA
import InstitutionalPageAtomic from './components/InstitutionalPageAtomic'; // 🎯 INSTITUTIONAL PAGE ATÔMICA
import UserProfilePageAtomic from './components/UserProfilePageAtomic'; // 🎯 USER PROFILE PAGE ATÔMICA
import ForgotPasswordPageAtomic from './components/ForgotPasswordPageAtomic'; // 🎯 FORGOT PASSWORD PAGE ATÔMICA
import PackagesPageAtomic from './components/PackagesPageAtomic'; // 🎯 PACKAGES PAGE ATÔMICA
import TestNewAtomicPagesWithBackend from './components/TestNewAtomicPagesWithBackend'; // 🧪 TESTE NOVAS PÁGINAS ATÔMICAS
...
const handleSaveTravel = (travelToSave) => {
    ...
    // 🏨 FUNÇÃO PARA NAVEGAR PARA TESTE HOTEL DETAILS ATOMIC
    const handleNavigateToHotelDetailsTest = () => {
        setCurrentPage('testHotelDetails');
        window.scrollTo({ top: 0, behavior: 'smooth' });
    };

    // 🎯 FUNÇÃO PARA NAVEGAR PARA TESTE TRAVEL SECTION ATOMIC
    const handleNavigateToTravelSectionTest = () => {
        setCurrentPage('testTravelSection');
        window.scrollTo({ top: 0, behavior: 'smooth' });
    };

    // 🎉 FUNÇÃO PARA NAVEGAR PARA TESTE EVENT BLOG SECTION ATOMIC
    const handleNavigateToEventBlogSectionTest = () => {
        setCurrentPage('testEventBlogSection');
        window.scrollTo({ top: 0, behavior: 'smooth' });
    };

    // 📧 FUNÇÃO PARA NAVEGAR PARA TESTE NEWSLETTER SECTION ATOMIC
    const handleNavigateToNewsletterSectionTest = () => {
        setCurrentPage('testNewsletterSection');
        window.scrollTo({ top: 0, behavior: 'smooth' });
    };

    // 🏨 FUNÇÃO PARA NAVEGAR PARA TESTE RECOMMENDED HOTELS SECTION ATOMIC
    const handleNavigateToRecommendedHotelsSectionTest = () => {
        setCurrentPage('testRecommendedHotelsSection');
        window.scrollTo({ top: 0, behavior: 'smooth' });
    };

    // 🗺️ FUNÇÃO PARA NAVEGAR PARA TESTE HOTELS MAP SECTION ATOMIC
    const handleNavigateToHotelsMapSectionTest = () => {
        setCurrentPage('testHotelsMapSection');
        window.scrollTo({ top: 0, behavior: 'smooth' });
    };

    // 📝 FUNÇÃO PARA NAVEGAR PARA TESTE BLOG SECTION ATOMIC
    const handleNavigateToBlogSectionTest = () => {
        setCurrentPage('testBlogSection');
        window.scrollTo({ top: 0, behavior: 'smooth' });
    };

    // 🎫 FUNÇÃO PARA NAVEGAR PARA TESTE PROMOTION DETAILS PAGE ATOMIC
    const handleNavigateToPromotionDetailsPageTest = () => {
        setCurrentPage('testPromotionDetailsPage');
        window.scrollTo({ top: 0, behavior: 'smooth' });
    };

    // 🛒 FUNÇÃO PARA NAVEGAR PARA TESTE PURCHASE PAGE ATOMIC
    const handleNavigateToPurchasePageTest = () => {
        setCurrentPage('testPurchasePage');
        window.scrollTo({ top: 0, behavior: 'smooth' });
    };

    // 💳 FUNÇÃO PARA NAVEGAR PARA TESTE PAYMENT PAGE ATOMIC
    const handleNavigateToPaymentPageTest = () => {
        setCurrentPage('testPaymentPage');
        window.scrollTo({ top: 0, behavior: 'smooth' });
    };

    // 🔐 FUNÇÃO PARA NAVEGAR PARA TESTE AUTH AND USER PAGES ATOMIC
    const handleNavigateToAuthAndUserPagesTest = () => {
        setCurrentPage('testAuthAndUserPages');
        window.scrollTo({ top: 0, behavior: 'smooth' });
    };

    // 🆕 FUNÇÃO PARA NAVEGAR PARA TESTE DAS NOVAS PÁGINAS ATÔMICAS COM BACKEND
    const handleNavigateToNewAtomicPagesTest = () => {
        setCurrentPage('testNewAtomicPages');
        window.scrollTo({ top: 0, behavior: 'smooth' });
    };
    ...
    return (
        <div className="min-h-screen flex flex-col">
            <Header
                ...
                onNavigateToHotelDetailsTest={handleNavigateToHotelDetailsTest}
                onNavigateToTravelSectionTest={handleNavigateToTravelSectionTest}
                onNavigateToEventBlogSectionTest={handleNavigateToEventBlogSectionTest}
                onNavigateToNewsletterSectionTest={handleNavigateToNewsletterSectionTest}
                onNavigateToRecommendedHotelsSectionTest={handleNavigateToRecommendedHotelsSectionTest}
                onNavigateToHotelsMapSectionTest={handleNavigateToHotelsMapSectionTest}
                onNavigateToBlogSectionTest={handleNavigateToBlogSectionTest}
                onNavigateToPromotionDetailsPageTest={handleNavigateToPromotionDetailsPageTest}
                onNavigateToPurchasePageTest={handleNavigateToPurchasePageTest}
                onNavigateToPaymentPageTest={handleNavigateToPaymentPageTest}
                onNavigateToAuthAndUserPagesTest={handleNavigateToAuthAndUserPagesTest}
                onNavigateToNewAtomicPagesTest={handleNavigateToNewAtomicPagesTest}
                currentPage={currentPage}
            />
            <main className="flex-grow">
                <HeroSwiper />
                {currentPage !== 'login' && currentPage !== 'register' && currentPage !== 'myTravels' && currentPage !== 'institutional' && currentPage !== 'testAtomic' && currentPage !== 'testComponents' && currentPage !== 'testBackend' && currentPage !== 'testHotelDetails' && currentPage !== 'testTravelSection' && currentPage !== 'testEventBlogSection' && currentPage !== 'testNewsletterSection' && currentPage !== 'testRecommendedHotelsSection' && currentPage !== 'testHotelsMapSection' && currentPage !== 'testBlogSection' && currentPage !== 'testPromotionDetailsPage' && currentPage !== 'testPurchasePage' && currentPage !== 'testPaymentPage' && currentPage !== 'testAuthAndUserPages' && currentPage !== 'testNewAtomicPages' && (
                ...
                : currentPage === 'testHotelDetails' ? <TestAtomicHotelDetails />
                : currentPage === 'testTravelSection' ? <TestTravelSectionAtomic />
                : currentPage === 'testEventBlogSection' ? <TestEventBlogSectionAtomic />
                : currentPage === 'testNewsletterSection' ? <TestNewsletterSectionAtomic />
                : currentPage === 'testRecommendedHotelsSection' ? <TestRecommendedHotelsSectionAtomic />
                : currentPage === 'testHotelsMapSection' ? <TestHotelsMapSectionAtomic />
                : currentPage === 'testBlogSection' ? <TestBlogSectionAtomic />
                : currentPage === 'testPromotionDetailsPage' ? <TestPromotionDetailsPageAtomic />
                : currentPage === 'testPurchasePage' ? <TestPurchasePageAtomic />
                : currentPage === 'testPaymentPage' ? <TestPaymentPageAtomic />
                : currentPage === 'testAuthAndUserPages' ? <TestAuthAndUserPagesAtomic />
                : currentPage === 'testNewAtomicPages' ? <TestNewAtomicPagesWithBackend />
